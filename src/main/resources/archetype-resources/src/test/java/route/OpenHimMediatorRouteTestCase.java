...
@UseAdviceWith
public class OpenHimMediatorRouteTestCase extends AbstractRouteFunctionalTestCase {
    ...
    public void testRegisterMediatorRoute() throws Exception {
        AdviceWith.adviceWith(
                ...
                a -> a.weaveByType(ToDefinition.class).replace().to("mock:register"));
    ...
    public void testHeartbeatRoute() throws Exception {
        AdviceWith.adviceWith(
                ...
                a -> a.weaveByType(ToDefinition.class).replace().to("mock:heartbeat"));
